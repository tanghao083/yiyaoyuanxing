...
# 本地应用路径
$localAppPath = "d:\yiyaoyuanxing\backend"
...
# 上传应用代码
echo "上传应用代码..."
scp -r "$localAppPath"/* "$username@$server:$remoteAppPath/"
...
# 启动服务器
echo \"启动服务器...\"
pm2 start server-final.js --name yirunjian-server
